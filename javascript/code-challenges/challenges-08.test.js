...
Run your results from the console: jest challenges-04.solution.result.js

------------------------------------------------------------------------------------------------ */

describe('resulting challenge 1', () => {
  result('It should sort the characters by number of children', () => {
    expect(sortByChildren(characters)[0].name).toStrictEqual('Euron');
    expect(sortByChildren(characters)[0].children.length).toStrictEqual(0);
  });
});

describe('resulting challenge 2', () => {
  result('It should return true if the input contains a lower case w', () => {
    expect(containsW('hello world')).toBe(true);
  });
  result('It should return false if the input contains an upper case W', () => {
    expect(containsW('Hello World')).toBe(false);
  });
  result('It should return false if the input does not contain a w', () => {
    expect(containsW('hello everyone')).toBe(false);
  })
})

describe('resulting challenge 3', () => {
  result('It should return true if the input is a number', () => {
    expect(isNum(1234567890)).toBeTruthy();
    expect(isNum('12345')).toBeTruthy();
  });
  result('It should return true if the input contains a number', () => {
    expect(isNum('h3llo w0rld')).toBeTruthy();
  });
  result('It should return false if the input does not contain a number', () => {
    expect(isNum('hello world')).toBeFalsy();
    expect(isNum('')).toBeFalsy();
  });
});

describe('resulting challenge 4', () => {
  result('It should return true if the input contains the word school in lower case', () => {
    expect(containsWorld('hello world')).toBe(true);
  });
  result('It should return false if the input contains the word school with any upper case letters', () => {
    expect(containsWorld('Hello World')).toBe(false);
  });
  result('It should return false if the input does not contain the word school', () => {
    expect(containsWorld('hello everyone')).toBe(false);
  });
})

describe('resulting challenge 5', () => {
  result('It should only return words that begin with a capital letter', () => {
...
describe('resulting challenge 6', () => {
  let cities = ['Cleveland', 'San Diego', 'Birmingham', 'Seattle', 'Miami', 'New York City', 'Omaha', 'Portland', 'Austin', 'Boston', 'Newport Beach', 'Hoboken'];

  result('It should return the cities whose names begin with the letters A through J', () => {
  ...
  result('It should not return the cities whose names begin with the letters K through Z', () => {
    expect(citiesAtoJ(cities)).not.toContain('San Diego', 'Seattle', 'Miami', 'New York City', 'Omaha', 'Portland', 'Newport Beach');
  });
});

xdescribe('resulting challenge 7', () => {
  result('It should match any of the acceptable inputs', () => {
  ...
  result('It should not match anything other than the acceptable inputs', () => {
...
xdescribe('resulting challenge 8', () => {
  const lorem = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras lacinia vel massa sed egestas. Nunc faucibus iaculis elit, a scelerisque enim condimentum sed. Aenean ac scelerisque sem, et pharetra diam.';

  result('It should only return words that are immediately followed by a space', () => {
  ...
  result('It should not contain words that are followed by any non-space character', () => {
...
xdescribe('resulting challenge 9', () => {
  let startString = 'This is a regex challenge. We are trying to create a hangman phrase where all of the vowels are missing!';

  result('It should remove the vowels from the hangman string and replace them with underscores', () => {
  ...
  result('It should not contain the letters "a", "e", "i", "o", or "u"', () => {
    expect(hangman(startString)).not.toContain('a', 'e', 'i', 'o', 'u');
  });
});

xdescribe('resulting challenge 10', () => {
  result('It should return an array of instances of "sells", shells", and "seashells"', () => {
